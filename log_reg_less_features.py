...
y_train = np.concatenate((y_split_less[3],y_split_less[5],y_split_less[2]))
y_val = np.concatenate((y_split_less[0],y_split_less[4]))
y_test = y_split_less[1]
print("y_train_less shape: \t", y_train.shape)
print("y_val_less shape: \t", y_val.shape)
print("y_test_less shape: \t", y_test.shape)
...
# feature scaling #
###################
X_train_scaled = (X_train_less - feature_mean)/(feature_std)
X_train = X_train_scaled
X_val_scaled = (X_val_less - feature_mean)/(feature_std)
X_val = X_val_scaled
X_test_scaled = (X_test_less - feature_mean)/(feature_std)
